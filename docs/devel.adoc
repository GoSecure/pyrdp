...
First, make sure to install the prerequisite packages (these are listed for Ubuntu 22.04 and 24.04, you might need to adjust for other distros). We provide two types of installs a full one and a
