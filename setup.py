...
setup(name='pyrdp',
    version='1.1.1.dev0',
    description='Remote Desktop Protocol Monster-in-the-Middle and library for Python 3',
    long_description="""Remote Desktop Protocol Monster-in-the-Middle and library for Python 3""",
