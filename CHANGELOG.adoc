...
* Documentation updates ({uri-issue}335[#335], {uri-issue}339[#339], {uri-issue}340[#340])
...
* Added a missing dependency for the GUI on Ubuntu 20.04 LTS ({uri-issue}351[#351], {uri-issue}355[#355])
